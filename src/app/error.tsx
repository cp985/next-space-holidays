...
export default function Error({
  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-[#050816]! px-6!">
      ...
      <div className="relative z-10 w-full max-w-xl rounded-3xl border border-white/10! bg-white/5! p-8! text-center backdrop-blur-xl">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button
            onClick={() => reset()}
            className="inline-flex items-center gap-2! rounded-2xl border border-white/10! bg-white/10! px-5! py-3! text-sm! font-medium! text-white! transition hover:bg-white/20! cursor-pointer"
          >

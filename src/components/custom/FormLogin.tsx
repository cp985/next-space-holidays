...
// Descrizione dialog
const descClass = cn(
  "text-white/40 text-sm tracking-wide",
);
...
const cancelBtnClass = cn(
  ...
  return (
    <DialogContent className={dialogClass}>
      <DialogHeader>
        <DialogTitle className={titleClass} >{isSignIn ? "Sign Up" : "Sign In"}</DialogTitle>
      ...
      <form className={formClass} action={actionF}>
        ...
        <Button className={toggleBtnClass} type="button" onClick={() => setIsSignIn(!isSignIn)}>

    ...
    <div className="flex items-center gap-4">
      <DropdownMenu>
        ...
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            >
              ...
              <span className="w-full h-fit p-0 bg-cyan-500/50 absolute bottom-0 left-0 text-center text-white text-shadow-black text-sm ">
                {userName}
              </span>
            </div>
          </Button>
        ...
        <DropdownMenuContent
          sideOffset={12}
          className={cn(
            "w-56 text-[16px] font-medium bg-black/80 backdrop-blur-md border-white/10 text-white rounded shadow-[0_4px_30px_rgba(0,0,0,0.5)]",
        ...
        >
          ...
          >
            <Link href="/dashboard" className="flex items-center gap-2 w-full focus:outline-none focus:ring-0">
